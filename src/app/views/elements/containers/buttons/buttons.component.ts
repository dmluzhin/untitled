...
export class ButtonsComponent implements OnInit {
  ...
  simpleButton = `<button class="button">Кнопка</button>`;
  buttonTypes = `<button class="button">Кнопка</button>
<a class="button">Анкорная ссылка</a>
<input class="button" value="Отправить" type="submit">`;
  buttonColors = `<div class="buttons">
  ...
  buttonAllSizes = `<div class="buttons are-medium">
  ...
  buttonFlex = `<div style="width: 300px;">
  ...
  buttonFlexible = `<div class="buttons is-flexible" style="width: 100%">
...
<div class="buttons is-flexible" style="width: 100%">
  ...
  buttonOutlned = `<div class="buttons">
